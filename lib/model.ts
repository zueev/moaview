...
export type Campaign={id:string;title:string;platform:string;url:string;kind:string;status:string;due:string;notes:string;tasks:Task[];created:string;announce?:string};
